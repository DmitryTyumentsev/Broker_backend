...
select
    ...
    -- раздаёт сценарный сидер: иначе объём упирается в частичный уникальный
    -- индекс на активных фиксациях и налив падает на середине. Заодно
    -- объём не подмешивается в сценарные наборы и не портит их разбор.
