...
import (
	...
	"Broker_backend/services/integration/partnerapi/internal/clients/brokerclient"
	"Broker_backend/services/integration/partnerapi/internal/config"
	redisclient "Broker_backend/services/integration/partnerapi/internal/infra/cache/redis"
...
func main() {
	...
	if err := app.Listen(addr); err != nil {
		logger.Fatal("partnerapi stopped", zap.Error(err))
	}
}
