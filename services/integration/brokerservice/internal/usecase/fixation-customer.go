...
func (s *Service) NewFixation(ctx context.Context, req *brokerdto.FixationRequest, agencyID, userID uuid.UUID) (*entity.FixationCustomer, error) {
...
func findProjectID(req *brokerdto.FixationRequest) (*brokerdto.FixationRequest, error) {
