...
import (
	"Broker_backend/services/brokerservice/internal/infra/repositories/postgres/features/fixationcustomer"
	"context"
	"errors"
	"fmt"
	"net"
	...
	"Broker_backend/services/brokerservice/internal/infra/clock"
	"Broker_backend/services/brokerservice/internal/infra/repositories/postgres"
	"Broker_backend/services/brokerservice/internal/transport/grpc/brokerhandler"
...
func Run() error {
	...
	// ═══════════════════════════════════════════════════════════════════
	fixationRepo := fixationcustomer.NewRepository(txManager)
